...
urlpatterns = [
    ...
    path('employees/<int:user_id>/fetch/', views.employees_view, {'semester_data_only': True}, name='employee-fetch'),
    ...
    path('employees/<int:user_id>/semester/<int:semester_id>/fetch/',
         views.employees_view, {"semester_data_only": True}, name='employee-fetch-semester'),
    path('students/<int:user_id>/', views.students_view, name='student-profile'),
    path('students/<int:user_id>/fetch/', views.students_view, {'semester_data_only': True}, name='student-fetch'),
    ...
    path('students/<int:user_id>/semester/<int:semester_id>/fetch/',
         views.students_view, {"semester_data_only": True}, name='student-fetch-semester'),
