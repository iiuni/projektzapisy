...
urlpatterns = [
    ...
    path('employees/<int:user_id>/fetch/', views.employees_view, {'sem_fetch': True}, name='employee-fetch'),
    ...
    path('students/<int:user_id>/fetch/', views.students_view, {'sem_fetch': True}, name='student-fetch'),
