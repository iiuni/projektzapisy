...
class CourseEntity(models.Model):
    ...
    exercises_laboratiories = models.IntegerField(
        null=True, blank=True, verbose_name=u'godzin ćwiczenio-pracowni')
    ...
    dyskretna_l = models.BooleanField(
        default=False,
        verbose_name=u'Przedmiot posiada również wersje: Dyskretna (L)')
    numeryczna_l = models.BooleanField(
        default=False,
        verbose_name=u'Przedmiot posiada również wersje: Numeryczna (L)')
    algorytmy_l = models.BooleanField(
        default=False,
        verbose_name=u'Przedmiot posiada również wersje: Algorytmy (L)')
    programowanie_l = models.BooleanField(
        default=False, verbose_name=u'Przedmiot posiada również wersje: Programowanie (L)')
    ...
    usos_kod = models.CharField(
        ...
        blank=True,
        default='',
        verbose_name=u'Kod przedmiotu w usos',
...
class CourseDescription(models.Model):
    ...
    lectures = models.IntegerField(
        verbose_name=u'różnica w godzinach wykładu',
        blank=True,
        null=True,
        default=0)
    repetitions = models.IntegerField(
        verbose_name=u'różnica w godzinach repetytoriów',
        blank=True,
        null=True,
        default=0)
    exercises = models.IntegerField(
        verbose_name=u'różnica w godzinach ćwiczeń',
        blank=True,
        null=True,
        default=0)
    laboratories = models.IntegerField(
        verbose_name=u'różnica w godzinach pracowni',
        blank=True,
        null=True,
        default=0)
    seminars = models.IntegerField(
        ...
        null=True,
        blank=True,
        verbose_name=u'różnica w godzinach seminariów')
    exercises_laboratories = models.IntegerField(
        verbose_name=u'różnica w godzinach ćw+prac', blank=True, null=True, default=0)
