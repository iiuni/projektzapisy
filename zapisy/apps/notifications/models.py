...
def get_all_users_from_group(group: Group):
...
class NotificationPreferencesStudent(models.Model):
    ...
    added_new_group = models.BooleanField(default=True, verbose_name='Dodanie nowej grupy przedmiotu, na który jesteś '
                                                                     'zapisany')
    teacher_has_been_changed_enrolled = models.BooleanField(default=True, verbose_name='Zmiana prowadzącego grupy z przedmiotu, '
                                                                                       'na który jesteś zapisany/a')
    teacher_has_been_changed_queued = models.BooleanField(default=True, verbose_name='Zmiana prowadzącego grupy z przedmiotu, '
                                                                                     'na który czekasz w kolejce')
