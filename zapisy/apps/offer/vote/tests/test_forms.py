...
class VoteFormsetTest(test.TestCase):
    ...
    def setUpTestData(cls):
        ...
        SingleVote.objects.bulk_create([
            SingleVote(state=cls.state,
                       student=cls.student2,
                       proposal=cls.proposals[0],
                       entity=cls.proposals[0].entity,
                       value=3),
            SingleVote(state=cls.state,
                       student=cls.student2,
                       proposal=cls.proposals[1],
                       entity=cls.proposals[1].entity,
                       value=0),
            SingleVote(state=cls.state,
                       student=cls.student2,
                       proposal=cls.proposals[2],
                       entity=cls.proposals[2].entity,
                       value=2),
            SingleVote(state=cls.state,
                       student=cls.student2,
                       proposal=cls.proposals[3],
                       entity=cls.proposals[3].entity,
                       value=2),
            SingleVote(state=cls.state,
                       student=cls.student2,
                       proposal=cls.proposals[4],
                       entity=cls.proposals[4].entity,
                       value=3),
            SingleVote(state=cls.state,
                       student=cls.student2,
                       proposal=cls.proposals[6],
                       entity=cls.proposals[6].entity,
                       value=2),
        ])
