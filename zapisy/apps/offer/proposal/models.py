...
class Syllabus(models.Model):
    ...
    studies_type = models.CharField(
        ...
        default='both',
        verbose_name=u'Kierunek studiów')
    year = models.IntegerField(
        null=True,
        blank=True,
        choices=year_choices,
        verbose_name=u'Rok studiów')
    requirements = models.TextField(
        verbose_name=u'Wymagania wstępne w zakresie wiedzy, umiejętności i kompetencji społecznych',
        blank=True,
        default='')
    objectives = models.TextField(verbose_name=u'Cele przedmiotu', blank=True, default='')
    effects_txt = models.TextField(
        verbose_name=u'Zakładane efekty kształcenia',
        blank=True,
        default='')
    effects_codes = models.TextField(
        verbose_name=u'Symbole kierunkowych efektów kształcenia',
        blank=True,
        default='',
    ...
    learning_methods = models.ManyToManyField(
        LearningMethod, verbose_name=u'Metody kształcenia', blank=True)
    literature = models.TextField(
        verbose_name=u'Zalecana literatura (podręczniki)',
        blank=True,
        default='')
    passing_form = models.TextField(
        verbose_name=u'Forma zaliczenia poszczególnych komponentów przedmiotu/modułu, sposób sprawdzenia osiągnięcia zamierzonych efektów kształcenia',
        blank=True,
        default='')
