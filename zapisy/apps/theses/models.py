...
class Thesis(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if (old and old.status == ThesisStatus.BEING_EVALUATED and self.status == ThesisStatus.BEING_EVALUATED and
            old.supporting_advisor != None and is_theses_board_member(old.supporting_advisor.user)):
            thesis_voting_activated.send(sender=self.__class__, instance=self, additional_notifiee=old.supporting_advisor.user)
