echo "alias prepare-env27='source ~/env2.7/bin/activate'" >> .bash_aliases
echo "alias prepare-env35='source ~/env3.5/bin/activate'" >> .bash_aliases
...
echo "source ~/env3.5/bin/activate" >> .bashrc
